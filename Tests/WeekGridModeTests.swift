...
struct WeekGridModeTests {
    ...
    func titles() throws {
        ...
        #expect(WeekDistanceTitle.title(weeks: -2, range: range) == range)
        #expect(WeekDistanceTitle.subtitle(weeks: -2, range: range) == "2 weeks ago")
        ...
        #expect(WeekDistanceTitle.subtitle(weeks: 1, range: range) == range)
        #expect(WeekDistanceTitle.title(weeks: 2, range: range) == range)
        #expect(WeekDistanceTitle.subtitle(weeks: 2, range: range) == "2 weeks ahead")
